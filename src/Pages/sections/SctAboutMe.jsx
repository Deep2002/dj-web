...
export default function SctAboutMe() {
  ...
  return (
    // about me section
    <div className="relative flex flex-col items-center justify-center md:min-h-[800px] min-h-[500px] w-screen bg-black text-white pt-20 pl-10 pr-10 overflow-hidden">
      <motion.div
        ref={ref}
      ...
      >
        ...
        <motion.p
          ...
          animate={isInView ? { opacity: 1, y: 0, scale: 1 } : {}}
          transition={{ duration: 0.7, ease: "easeOut" }}
          className="md:mt-4 lg:text-[1.5em] mt-2 text-[#9B9B9B] font-bricolage"
        >
          Bringing high-energy Bollywood, Hollywood, and Reggaetón beats to the
          club scene. Based in Dallas, I create unforgettable nights with
          seamless mixes, crowd-hyping transitions, and a deep understanding of
          the vibe. From chill lounge sets to peak-hour bangers, I make every
          moment flow.
          <br />
          <br />
